 ...
 */
package com.fernandocejas.sample.presentation
...
@Inject constructor(
    ...
    var movieDetails: MutableLiveData<com.fernandocejas.sample.presentation.MovieDetailsView> = MutableLiveData()
    ...
    private fun handleMovieDetails(movie: MovieDetails) {
        this.movieDetails.value = com.fernandocejas.sample.presentation.MovieDetailsView(movie.id, movie.title, movie.poster,
