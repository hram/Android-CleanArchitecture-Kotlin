...
import com.fernandocejas.sample.presentation.MovieDetailsActivity
import com.fernandocejas.sample.presentation.MovieView
...
@Inject constructor(private val authenticator: Authenticator) : Navigator {
    ...
    fun showMovieDetails(activity: FragmentActivity, movie: com.fernandocejas.sample.presentation.MovieView, navigationExtras: Extras) {
        val intent = com.fernandocejas.sample.presentation.MovieDetailsActivity.callingIntent(activity, movie)
